...
(function() {
    ...
    const i18n = new Map([
        // ['', ''],
        ['Shared Environment Variables are set at the Team level.', '共享环境变量是在团队级别设置的。'],
        ['No Shared Environment Variables are set.', '未设置共享环境变量。'],
        ['Search for a Project to link to…', '搜索要链接的项目…'],
        ['or paste the .env contents above', '或粘贴上面的 .env 内容'],
        ['Link to Projects', '链接到项目'],
        ['Sensitive environment variables cannot be created in the Development environment.', '开启后你将不能创建环境变量'],
        ['If enabled, you and your team will not be able to read the values after creation.', '如果启用，您和您的团队在创建后将无法读取这些值。'],
        ['Environment Variables added to the Team can be used by all, or a subset of, your Projects.', '添加到团队的环境变量可以被所有项目或项目的一部分使用。'],
        ['Used when interacting with the Vercel API.', '用于使用Vercel API时'],
        ['Learn more about', '了解更多信息关于'],
        ['Enable the Vercel Toolbar on your Deployments.', '在项目上设置Vercel Toolbar会覆盖该选项。'],
        ['Enable the Vercel Toolbar on your Deployments.', '在您的部署上启用Vercel工具栏。'],
        ['This is your team\'s avatar.', '这是您团队的头像。'],
        ['This is your team\'s URL namespace on Vercel. Within it, your team can inspect their projects, check out any recent activity, or configure settings to their liking', '这是您在Vercel上的团队URL命名空间。在其中,您的团队可以检查他们的项目,查看任何最近的活动,或者根据他们的喜好配置设置。'],
        ['Security & Privacy', '隐私与安全'],
        ['Upgrade to Pro to create your first Drain.', '升级到专业版以创建您的第一个Drains'],
        ['Get started with Drains', '开始使用Drains'],
        ['Forward Logs, Traces, Speed Insights, and Analytics to third-party providers or your own custom endpoints.', '将日志、跟踪、速度洞察和分析转发到第三方提供商或您自己的自定义端点。'],
